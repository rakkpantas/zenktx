...
// Newest first: the last item added in movies.json should appear first in the grid
// (platform pages should follow JSON insertion order, not Latest Home ordering).
$filteredMovies = array_reverse($filteredMovies);
